...
import (
	...
	types1 "github.com/cosmos/cosmos-sdk/x/symstaking/types"
...
func (m *MockStakingKeeper) IterateValidators(arg0 context.Context, arg1 func(int64, types2.ValidatorUpdate) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) SlashWithInfractionReason(arg0 context.Context, arg1 []byte, arg2, arg3 int64, arg4 math.LegacyDec, arg5 types1.Infraction) (string, error) {
	m.ctrl.T.Helper()
